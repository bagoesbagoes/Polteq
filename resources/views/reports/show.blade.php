        ...
        <div class="bg-gray-800 shadow-lg rounded-lg overflow-hidden border border-gray-700">
            ...
            <div class="bg-gray-900/50 px-6 py-4 border-t border-gray-700 flex justify-between items-center">
                ...
                @if($report->surat_tugas_path)
                    <div class="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg gap-3">
                        <div class="flex items-center gap-3">
                            <div>
                                <p class="text-white font-medium">Surat Tugas Akhir</p>
                            </div>
                        </div>
                        <a href="{{ route('reports.download-surat-tugas', ['type' => $type, 'report' => $report]) }}" 
                ...
                @if($report->file_path)
                    <div class="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg gap-3">
                        <div>
                            <p class="text-white font-medium">File Laporan Akhir</p>
                        </div>
