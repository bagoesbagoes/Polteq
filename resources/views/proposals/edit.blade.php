<x-layout>
    <x-slot:title>Edit Proposal usulan - {{ $proposal->judul }}</x-slot:title>
        ...
        <form method="POST" action="{{ route('proposals.update', $proposal) }}" enctype="multipart/form-data" class="bg-gray-800 shadow sm:rounded-lg p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="border-b border-gray-700 pb-4">
                    <h2 class="text-xl font-semibold text-white">Edit Proposal usulan</h2>
                ...
                <div>
                    <label for="deskripsi" class="block text-sm font-medium leading-6 text-white">
                        Abstrak/Deskripsi <span class="text-red-500">*</span>
                    </label>
                    <textarea 
                        name="deskripsi" 
                        id="deskripsi" 
