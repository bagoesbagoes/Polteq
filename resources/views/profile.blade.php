  ...
  <div class="mt-6 border-t border-white/10">
    <dl class="divide-y divide-white/10">
      <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
        ...
        <dd class="mt-1 text-sm/6 text-gray-400 sm:col-span-2 sm:mt-0">Chrisantus Bagus Susetio Hadi</dd>
      </div>
      ...
      <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
        ...
        <dd class="mt-1 text-sm/6 text-gray-400 sm:col-span-2 sm:mt-0">@chrisantusbagusw.com</dd>
      </div>
